 ...
 <script type="text/javascript">
 	...
 	$(function(){
 		...
 		$('#btn_modify').click(function(){
 			frm.attr('action', '/fboard/modifyPage'); // 컨트롤러로 보낸다.
 			frm.attr('method','get');
 			frm.submit();
 		});
 		
 		$('#btn_delete').click(function(){
 			frm.attr('action', '/fboard/deletePage'); // 컨트롤러로 보낸다.
 			frm.submit();
 		});
 		$('#btn_list').click(function(){
		 	//self.location="/bbs/pageList";
		 	frm.attr('method','get');
		 	frm.attr('action','/fboard/list');
		 	frm.submit();
 		});
 	});
                      	  ...
                      	  <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="articleType"
                                  			value="${boardVO.articleType }" readonly="readonly">
